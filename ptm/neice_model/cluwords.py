...
from utils import build_word_vector_matrix, sparse_division, sparse_matrix_vector_multiplication
...
class Cluwords(object):
    def __init__(self, embeddings, n_words, k_neighbors, output_dir, threshold=0.85, n_jobs=1):
